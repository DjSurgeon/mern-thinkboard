 ...
 * @details It displays the note's title, content, creation date, and includes actions for editing and deleting the note.
...
const Notecard = ({
	...
	return (
		<Link
			...
			aria-label={`See note titled: ${note.title}`}>
